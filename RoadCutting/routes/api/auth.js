...
router.get("/", async (req, res) => {
  ...
  const options = {
    method: "POST",
    url:
      "https://uttarakhand-uat.egovernments.org/egov-mdms-service/v1/_search?tenantId=uk",
    headers: {
...
router.post(
  "/",
  [
    check("user", "User name should not be empty")
      .not()
      .isEmpty(),
    check("password", "Password is required")
      .not()
      .isEmpty(),
    check("tenant_Id", "City is required")
      .not()
      .isEmpty()
  ],
  (req, res) => {
