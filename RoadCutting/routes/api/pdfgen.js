...
router.post('/',async(req,res)=>{
  //console.log(req.body);
    try {
        ...
        var options = {
            'method': 'POST',
  'url': 'https://uttarakhand-dev.egovernments.org/pdf-service/v1/_create?key=misc-receipt&tenantId=uk',
  'headers': {
    ...
    'sec-fetch-mode': 'cors',
    'referer': 'https://uttarakhand-dev.egovernments.org/employee/uc/search',
