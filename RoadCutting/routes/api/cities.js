...
router.post("/", async (req, res) => {
  ...
  var options = {
    method: "POST",
    url:
      "https://uttarakhand-uat.egovernments.org/egov-location/location/v11/boundarys/_search?hierarchyTypeCode=REVENUE&boundaryType=Locality&tenantId=uk.dehradun",
    headers: {
      ...
      "sec-fetch-mode": "cors",
      referer:
        "https://uttarakhand-uat.egovernments.org/employee/tradelicence/apply?tenantId=uk.haridwar",
